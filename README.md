...
HBNB
This is the console /command interpreter for the ALX SE Airbnb clone project. The console can be used to store objects in and retrieve objects from a JSON.
